...
# 下载zip 压缩包 或git clone
wget -c https://github.com/redis/redis/archive/refs/tags/7.2.7.zip
```
...
make PREFIX=/home/hello/code/redis-7.2.7/out install
#
